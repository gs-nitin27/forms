        ...
        <td bgcolor="#5766BE">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 40px 40px 20px;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: #333333; font-weight: normal;"><?php echo $name; ?></h1>
                </td>
            </tr>
            <tr>
           <td bgcolor="#ffffff" style="padding: 0 40px 10px; font-family: sans-serif; font-size: 18px; line-height: 20px; color: #555555;">
            <p>We regret to inform you that your event has been cancelled unexpectedly and this could be due to the several reasons:</p>
            </td>
            </tr>
            <tr>
      ...
      <tr>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                    <p style="margin: 0;">We kindly request you to provide the right details, so that we can rectify all the mistakes in the event and post it from our side.</p>

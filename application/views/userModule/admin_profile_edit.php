...
var data1 = {
    ...
    "access_module"           : $("#access_module").val(),
    "status"                  : $("#status").val(),
...
var data = JSON.stringify(data1);
  $.ajax({
    type: "POST",
    url: '<?php echo site_url('forms/edit_admin'); ?>',
    data: "data="+data,
    dataType: "text",
       ...
       if(result == '1')
         ...
         buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                 window.location.href = url+"/forms/adminedituser";
                }
            },
            close: function () {
           window.location.href = url+"/forms/adminedituser";
  ...
  $(function() {
    ...
    <section class="content-header">
      ...
      <div class="col-md-12">
         ...
         <?php  $profile = $this->register->admin_user_module($id); 
           // print_r($profile); 
            // print_r($id); 
              ...
              <div class="tab-pane active" id="tab_event">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="UserId"  id="uid" value="<?php echo $value['adminid']; ?>">
                    ...
                    <input type="hidden" name="access_module" id="access_module" value="<?php echo $value['access_module']; ?>">
                    </div >
...
$.ajax({
  type     : "POST",
   url      :'<?php echo site_url('forms/adminchange_password')?>',
   data     :"data="+data,
  dataType : "json",
  success :function(result){

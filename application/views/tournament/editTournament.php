...
<!-- 					<div class="form-group">
    ...
    <img style="display:block; border:2px solid SteelBlue"; width="380px" height="260px" src = "<?php  echo base_url()."uploads/tournament/".$tournament['image']; ?>">
    <?php } else { ?>
    ...
    <input type="hidden" class="form-control" name="oldimage" id="oldimage" value="<?php echo $tournament['image']; ?>">
    <input type="hidden" class="form-control" name="oldimageid" id="oldimageid" value="<?php echo $tournament['id']?>">
    </div>
    <!-- <input id="button" type="submit" value="Upload"> -->
    </form>
    <img src="<?php echo base_url("img/loader.gif");?>"  id="loader_img" hidden></img> 
    <input type="hidden" class="form-control" name="photo" id="photo_url" value="<?php echo $tournament['image'];?>"> 

...
<div class="wrapper">
  <div class="content-wrapper">
    <section class="content">
      ...
      if($usertype==101 || $usertype==102 )
        {
              $guide = $this->register->getperformanceguideline();
        ...
        else
        {
          ...
          <tr>
					<td><?php echo $i++; ?></td>
           <td><?php echo $guideline['sport']; ?></td>
					<!-- <td><?php// echo $questions['question']; ?></td> -->
					<td><?php echo $guideline['age_group']; ?></td>
					<td><?php echo $guideline['gender']; ?></td>
          ...
          <?php } ?>
            ...
            $list=array('a' => 0,
                                ...
                                $num=$temp;
                                { ?> 
		  <td><a href = "<?php echo site_url('forms/editguidelines/'.$num.'?performance'); ?>" class="btn btn-xs btn-default bs-tooltip"  title="Edit" ><i class="glyphicon glyphicon-edit"></i></a></td>
                </tr>
		  <?php } } } ?>
                </tbody>
                <tfoot>
